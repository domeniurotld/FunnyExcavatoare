    ...
    <header class="header">
      <div class="row desktop-only align-items-center">
        <nav class="nav nav-right">
          ...
          <button class="tab-button" @click="scrollToSection('products')">Excavatoare</button>
      ...
      <div class="col mobile-only">
        ...
        <nav class="nav nav-left" style="margin-top: 1rem; margin-bottom: 1rem;">
          <div style="display: flex; justify-content: center; width: 100%; gap: 1rem; padding: 0 1rem;">
            <button class="tab-button" style="width: 45%;" @click="goToRoute('/')">Acasă</button>
            <button class="tab-button" style="width: 45%;" @click="scrollToSection('aboutus')">Despre noi</button>
          </div>
          <div style="display: flex; justify-content: center; width: 100%; gap: 1rem; padding: 0 1rem;">
            <button class="tab-button" style="width: 45%;" @click="scrollToSection('products')">Excavatoare</button>
